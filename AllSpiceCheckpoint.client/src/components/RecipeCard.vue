<template>
  <div class="component my-2 rounded-3 mt-4 elevation-5 hover" :style="{ backgroundImage: `url(${recipe.img})` }">
    <div class="d-flex justify-content-between">
      ...
      <i class="mdi mdi-heart text-danger p-2 heart rounded-bottom mx-2"></i>
    </div>
    <div class="" >
      <p class="title p-1 rounded-2 hoverable" @click="getRecipeDetails()" data-bs-toggle="modal" data-bs-target="#exampleModal">{{ recipe.title }}</p>
    </div>
  </div>
</template>
